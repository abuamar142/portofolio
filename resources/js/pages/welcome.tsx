    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-white">
                {/* 🔹 Navbar */}
                <header className="fixed top-0 left-0 w-full bg-opacity-90 py-4 shadow-md backdrop-blur-md">
                    <div className="container mx-auto flex items-center justify-between px-6">
                        ...
                        <button className="block md:hidden text-blue-500">
                ...
                <section id="about" className="container mx-auto px-6 py-16 text-center">
                    ...
                    <div className="mx-auto max-w-3xl space-y-6 text-sm text-gray-600 dark:text-gray-300 md:text-lg">
                        <p>
                ...
                <section id="contact" className="container mx-auto px-6 py-16 text-center">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 md:text-lg">If you want to contact me, please contact me here</p>
                ...
                {/* 🔹 Footer */}
                <footer className="w-full py-6 text-center text-sm text-gray-800 backdrop-blur-md dark:text-white">
